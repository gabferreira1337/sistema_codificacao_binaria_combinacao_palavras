 ...
 * to txt file and after read data from that file to a new Dynamic array
 */
void test_function_2_10_ad();
/**
 * @paragraph Use txt files for input and output sets of words and their
 * respective UFP6 representations LL
 * In this function we test all functions to write a linked list LL_WORDS_HOLDER
 * to txt file and after read data frmo that file to a new Linked List
 */
void test_function_2_10_ll();
/**
 * @paragraph Use bin files for input and output  sets of words and their
 * respective UFP6 representations
 ...
 * respective ufp6 representations
 * In this function we test all functions to write a linked list LL_WORDS_HOLDER
 * to bin file and after read data from that file to a new Linked List
 */
